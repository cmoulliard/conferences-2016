...
* More info {icon-arrow-right}
  - https://github.com/FuseByExample/mobile-rest-in-action[Mobile REST in Action]
  - https://github.com/FuseByExample/rest-dsl-in-action[REST Backend with Camel DSL]