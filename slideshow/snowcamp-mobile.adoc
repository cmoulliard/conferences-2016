...
* Tools : Cordova, Grunt, Nodejs, Ionic
* RedHat Mobile Platform
* *Demo - Part I / Local
...
* image:web/AngularJS-small.png[400,400]

// ************** frameworks ********
[#ionicframework]
== Ionic

* Fully integrated with AngularJS
* Provide AngularJS Extension
* Huge collection of Widgets (List, Buttons, Footers, ...)

image:mobile/ionic-logo.jpg[100,100]

image:mobile/ionicview.png[]
...
* image:mobile/cordova-plugins.jpg[200,200]

1. Web Based App wrapped into a native Shell
2. Access to native feature through JS Bridge
3. Multiplatform
...
* More info {icon-arrow-right}
  - [Mobile & Backend in Action](https://github.com/FuseByExample/mobile-rest-in-action)
